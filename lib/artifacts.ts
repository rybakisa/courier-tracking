...
export const artifacts: Artifact[] = [
  ...
  },
  {
    slug: 'scalability',
    num: '06',
    title: 'Масштабируемость / отказоустойчивость',
    subtitle: 'Скейлинг и поведение при отказах: соединения, Kafka, pub/sub, шардинг',
  ...
  },
  {
    ...
    num: '07',
    title: 'Мониторинг',
    subtitle: 'Four Golden Signals, свежесть, сатурация, сигналы отказов, SLO/SLI',
